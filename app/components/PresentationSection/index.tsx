      ...
      <div className="max-w-7xl mx-auto px-4 min-[1045px]:px-8 ">
        <div className="flex flex-col min-[1045px]:flex-row items-center gap-14 min-[1236px]:py-[120px] pt-[60px]">
          <div className="contents min-[1045px]:flex min-[1045px]:flex-col min-[1045px]:order-2 min-[1045px]:flex-1">
            ...
            <span className="order-3 text-[20px] font-josefin-sans text-[#4B575E] block text-center min-[1045px]:text-left">
              Meu nome é Giovana, sou vegana, amo os animais e faço retratos de
              pets há 5 anos. Moro no interior de São Paulo - Brasil com meu
              yorkshire e meu sonho é ter um gatinho. Sou estudante de ADS e já
              penso na próxima graduação (que com certeza será biologia). Assim
              como muitas pessoas criativas, desenho desde pequena. Sou
          ...
          <div className="order-2 max-w-[416px]	 min-[1045px]:order-1 relative w-full min-w-0 min-h-[496px] rounded-3xl overflow-hidden min-[1045px]:w-[416px] min-[1045px]:min-w-[416px] min-[1045px]:min-h-[496px]">
            <Image
              src="/selfie.png"
              alt="selfie"
              fill
